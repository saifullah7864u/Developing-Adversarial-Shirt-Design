...
import numpy as np
import math
import generator.EOT_simulation.eulerangles as eu
...
def target_sample(display=False):
    ...
    pts1 = np.float32(
        [[x_0f0_1, y_0f0_1], [x_0f0_2, y_0f0_2], [x_0f0_3, y_0f0_3], [x_0f0_4, y_0f0_4]])
    ...
    for item in sample_6para:
        ...
        # choose use M or M0
        sample_matrixes.append(
            [M0[0][0], M0[0][1], M0[0][2], M0[1][0], M0[1][1], M0[1][2], M0[2][0], M0[2][1]])
